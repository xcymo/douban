      ...
      <div ref="slideGroup1">
        ...
        <div class="movieInfo">
          ...
          <div class="infoRight">
            ...
            <div class="ir2" :class="{smallFont : movie.overallRating<0}">
              {{movie.overallRating
              < 0 ? '尚未上映' : movie.overallRating}}
            </div>
        ...
        <div class="commentDiv">
          ...
          <button class="btnRight">
            看过
            <i class="icon iconfont icon-kongxing starS"></i>
            <i class="icon iconfont icon-kongxing starS"></i>
            <i class="icon iconfont icon-kongxing starS"></i>
            <i class="icon iconfont icon-kongxing starS"></i>
            <i class="icon iconfont icon-kongxing starS"></i>
        ...
        <div class="discuss">
          <el-tabs :stretch="true">
            ...
            <el-tab-pane label="影评">
              ...
              <div ref="slideBox4">
                <div ref="slideGroup4">
                  <div class="discussBox" v-for="comment in longComments" :key="comment">
                    <div class="headIcon">
...
export default {
  ...
  created() {
    axios
      .get(
        "/api/movieDetail?locationId=290&movieId=" + this.$route.params.movieId
      )
      .then(res => {
